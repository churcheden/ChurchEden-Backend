                      ...
                      <td style="background:linear-gradient(135deg,#2A241D 0%,#1D1813 100%);padding:26px 28px;border-bottom:1px solid #F0EDE6;">
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td align="right">
                              <span style="font-family:'Inter',Arial,sans-serif;font-size:11px;font-weight:600;color:#C8A95C;letter-spacing:0.12em;text-transform:uppercase;">Password Reset</span>
                            </td>
                          </tr>
                        </table>
                      </td>
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                          ...
                          <tr><td style="padding-bottom:14px;">
                            <h1 style="margin:0;font-family:'Fraunces',Georgia,serif;font-size:28px;font-weight:700;color:#242019;line-height:1.2;letter-spacing:-0.5px;">
                              Forgot your<br/><span style="color:#C29A3B;">password?</span>
                            </h1>
                          </td></tr>

                          <tr><td style="padding-bottom:28px;">
                            <p style="margin:0;font-family:'Inter',Arial,sans-serif;font-size:15px;line-height:1.75;color:#5A564E;">
                              No worries — it happens to all of us. Click the button below to set a new password for your ChurchEden account.
                            </p>
                          </td></tr>
                          ...
                          <tr><td style="padding-bottom:28px;text-align:center;">
                            <a href="${resetUrl}"
                              style="display:inline-block;background:linear-gradient(135deg,#C9A24A 0%,#B3862E 100%);color:#241D12;font-family:'Inter',Arial,sans-serif;font-size:14px;font-weight:700;text-decoration:none;padding:15px 38px;border-radius:12px;box-shadow:0 10px 24px -10px rgba(179,134,46,0.55);">
                              Reset My Password →
                            </a>
                          </td></tr>
                          ...
                          <tr><td style="padding-bottom:24px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td style="background:#FDF3F3;border:1px solid #F3D8D8;border-radius:10px;padding:13px 16px;">
                                  <p style="margin:0;font-family:'Inter',Arial,sans-serif;font-size:13px;line-height:1.6;color:#B5382A;">
                                    ⚠️ &nbsp;This link expires in <strong>15 minutes</strong>. If you didn't request this, ignore this email — your account is safe.
                                  </p>
                                </td>
                              </tr>
                            </table>
                          ...
                          <tr><td style="padding-bottom:24px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td style="background:#FBF8F1;border:1px solid #F0EBDD;border-radius:10px;padding:14px 16px;">
                                  <p style="margin:0 0 4px;font-family:'Inter',Arial,sans-serif;font-size:11px;font-weight:600;color:#9A948A;letter-spacing:0.12em;text-transform:uppercase;">Button not working?</p>
                                  <p style="margin:0;font-family:'Inter',Arial,sans-serif;font-size:12px;color:#B3862E;word-break:break-all;line-height:1.6;">${resetUrl}</p>
                                </td>
                              </tr>
                            </table>
                          </td></tr>
